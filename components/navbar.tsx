...
export default function Navbar({ scrollY }: NavbarProps) {
  ...
  return (
    ...
    >
      <div className="nav-weave">
        <img src="https://cdn.builder.io/api/v1/image/assets%2F5c758e804cba4fa3a488e9088887877b%2F600eb541fd904e9a83d2dcc177639ce2?format=webp&width=800" alt="woven-snake" className="nav-weave-img" />
        ...
        <div className="nav-weave-strip nav-weave-strip-1" aria-hidden="true" />
        <div className="nav-weave-strip nav-weave-strip-2" aria-hidden="true" />
        <div className="nav-weave-strip nav-weave-strip-3" aria-hidden="true" />
