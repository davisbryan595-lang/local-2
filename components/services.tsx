        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className={`group relative p-8 rounded-xl border border-primary/20 bg-gradient-to-br ${service.color} hover-glow transition-all duration-300 cursor-pointer`}
              >
